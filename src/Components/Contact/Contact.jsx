      ...
      <div className={styles.container}>
        ...
        <p style={{ color: `${newTheme.para}` }} className={styles.paragraph}>
          ...
          <p style={{ color: `#00a0a0`, lineHeight: ``,fontSize:`20px` }}>
            {/* {" "} */}
            Email: rahulgl0303@gmail.com
          </p>

		  <p style={{ color: `#00a0a0`,fontSize:`20px`}}>
		  Mobile: +91-<span style={{ color: `#00a0a0`, fontSize:`20px`, textDecoration: `underline` }} >8962647680</span>{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}
          </p>
		  <p style={{ color: `#00a0a0`,fontSize:`20px` }}>
        ...
        >
          ...
          <a
            href="https://twitter.com/rahulgoyal0303"
            aria-label="Twitter"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/RahulGoyal03"
            aria-label="GitHub"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/therahulgoyal/"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
