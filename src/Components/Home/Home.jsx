      ...
      >
        ...
        >
          ...
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/file/d/1RR0DvI_dLvGoRwojrF2hOyvf4ndNgkNY/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              <Button
        ...
        >
          <img
            src="https://github.com/RahulGoyal03/Portfolio/blob/main/public/IMG_3379-removebg-modified_ccexpress__1_-removebg-preview.png?raw=true"
            alt="Profile pic"
          />
        </div>
      </div>
